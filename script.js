//566b60ef3dbbdde5589a013ed682720a
...
function showWeatherReport(weather){
    ...
    if(weatherType.textContent == 'Clear'){
        document.body.style.backgroundImage = "url('image/sun.gif')"
    }
    else if(weatherType.textContent == 'Clouds'){
        document.body.style.backgroundImage = "url('image/cl.gif')"
    }
    else if(weatherType.textContent == 'Rain'){
        document.body.style.backgroundImage = "url('image/raining.gif')"
    }
